...
export default function EnhancedTable() {
  ...
  const handleSelectAllClick = (event) => {
    if (event.target.checked) {
      const newSelecteds = training.map((n) => n.name);
  ...
  const emptyRows =
    rowsPerPage - Math.min(rowsPerPage, training.length - page * rowsPerPage);
        ...
        <TableContainer>
          ...
          >
            <EnhancedTableHead
              ...
              rowCount={training.length}
            />
            <TableBody>
              {stableSort(training, getComparator(order, orderBy))
                ...
                .map((training, id) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{training.duration}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
